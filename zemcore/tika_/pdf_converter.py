...
from zemcore.zemberek.settings import tikaURL
...
class PDFParser:
    def __init__(self, file):
        ...
        self.tikapath = self.localpath + 'tika_-app-1.18.jar'  # path to Apache Tika jar file
        self.file = file
    ...
    def parse(self):
        if os.path.exists(self.tikapath) == True:
            ...
            print("Downloading tika_-app-1.18.jar..")
