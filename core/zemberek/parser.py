...
from core.zemberek.main_libs import nltk_download, ZemberekTool
from core.kefir_.subject import Person
from core.kefir_.predication import personal, inferential
